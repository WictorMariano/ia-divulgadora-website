...
export function PricingShaderCanvas() {
  ...
  useEffect(() => {
    ...
    gl.uniform3fv(bgColorLoc, new Float32Array([0, 0, 0]));
  ...
  return (
    <div ref={containerRef} className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div
        aria-hidden
        className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_40%,transparent_20%,rgb(0_0_0/0.55)_70%,rgb(0_0_0/0.85))]"
      />
    </div>
  );
}
