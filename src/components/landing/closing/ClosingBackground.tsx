export function ClosingBackground() {
  return (
    <div className="closing-section-bg pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      <div className="closing-experience-top-glow absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgb(56_189_248/0.08),transparent_55%)]" />
    </div>
  );
}
